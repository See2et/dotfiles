...
vim.keymap.set('n', 'zf', '<cmd>lua require("telekasten").find_notes()<CR>')
vim.keymap.set('n', 'zd', '<cmd>lua require("telekasten").find_daily_notes()<CR>')
vim.keymap.set('n', 'zg', '<cmd>lua require("telekasten").search_notes()<CR>')
vim.keymap.set('n', 'zz', '<cmd>lua require("telekasten").follow_link()<CR>')
